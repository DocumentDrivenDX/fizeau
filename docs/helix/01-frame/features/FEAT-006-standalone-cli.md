...
| AC-FEAT-006-06 | `--profile`, `--model-ref`, and `--backend` are removed or rejected with clear migration guidance. | `go test ./agentcli ./cmd/fiz -run 'RejectsProfile|RejectsModelRef|Backend'` |
